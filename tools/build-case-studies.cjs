...
const CASES = [
  ...
  },
  {
    ...
    meta: 'Residential installation · $38M revenue · acquired by NXT Level Homes, 2025',
    metricBig: '~$624K',
    metricUnit: 'Annual EBITDA impact',
    blurb: 'Scheduling engine replaces guesswork with math. $12K/week in hidden labor — recovered.',
    lead: 'A scheduling engine that replaces dispatcher guesswork with an ILP solver — optimizing crew-to-job assignment across cost, skill and geography, and recovering $12K/week of hidden labor inefficiency at a single $38M-revenue operator.',
    bullets: [
    ...
    scale: {
      ...
      rows: [
        ...
        ['Business revenue', '$38M'],
        ['Time to live', 'Within the engagement'],
      ],
      note: 'Figures reflect a single ~$38M-revenue operator — not a portfolio rollup.',
    },
  ...
  },
  {
    ...
    lead: 'Supplier invoice verification turned into an automated check against contracted pricing — moving expert judgment off the senior construction manager and onto an offshore bookkeeper, with no loss of accuracy, at a single $38M-revenue operator.',
    bullets: [
  ...
  },
  {
    ...
    meta: 'Residential solar · $35M revenue · 1,600 installs/yr',
    metricBig: '~$1.76M',
    metricUnit: 'Annual EBITDA impact',
    blurb: 'Post-install visits cut in half. $1.76M/yr — plus $1.5M cash unlocked on day one.',
    lead: 'An operations redesign and supporting build that halved post-install service visits and compressed the cash conversion cycle at a single $35M-revenue solar operator — $1.76M/yr in recurring impact, plus $1.5M+ of one-time cash unlocked from the funding backlog.',
    bullets: [
